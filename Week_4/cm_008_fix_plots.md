...
ggplot(mpg, aes(cty, hwy)) +
  ...
  geom_smooth(method="lm")+ #This line is fitting to actual points not the jittered points
  theme_bw()
```

![](cm_008_fix_plots_files/figure-html/unnamed-chunk-2-1.png)<!-- -->
...
gapminder %>% 
  # group_by(country) %>% 
  ggplot(aes(year, lifeExp,group=country,colour=country=="Rwanda")) + #ggplot is grouping the country
  geom_line(alpha=0.2) + 
  scale_colour_discrete("",labels=c("Other","Rwanda")) #Very first quotation mark is nothing , so removes title
```

![](cm_008_fix_plots_files/figure-html/unnamed-chunk-3-1.png)<!-- -->
...
ggplot(gapminder, aes(gdpPercap, lifeExp)) +
  ...
  scale_x_log10(labels=scales::comma_format())+ #converts scientific notation to commas
  facet_wrap(~continent,scales="free") # splits up plot for each continent and even labels them, scales=free frees up x and y axis for each plot, but we can no longer compare between each plot 
```

![](cm_008_fix_plots_files/figure-html/unnamed-chunk-4-1.png)<!-- -->
...
gapminder %>% 
  ...
  geom_point(alpha = 0.5,shape=21) + # shape= 21 is a hollow circle 
  scale_x_log10(labels = scales::comma_format())+
  scale_size_area()# mapping by area to solve overplotting issue
```

![](cm_008_fix_plots_files/figure-html/unnamed-chunk-5-1.png)<!-- -->

```r
#colour= outside area of of the object, fill is the inside of the foll
```
...
![](cm_008_fix_plots_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](cm_008_fix_plots_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](cm_008_fix_plots_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
![](cm_008_fix_plots_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
![](cm_008_fix_plots_files/figure-html/unnamed-chunk-10-1.png)<!-- -->
...
![](cm_008_fix_plots_files/figure-html/unnamed-chunk-12-1.png)<!-- -->
...
![](cm_008_fix_plots_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
