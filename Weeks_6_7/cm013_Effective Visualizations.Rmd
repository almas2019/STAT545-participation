...
4. Scales make sense(like log for GDP for ex. )
5.Division of categories in plots in way that makes sense
...
- << Weak because more hours work does not mean more productive work (have to look at productivity in different) or more motivation, also there is no way to tell if data = significant>>
...
> 
> Yes, No, Do not know
- <<Do Not Know/No, becuase I can't tell with the way data is presented, it looks like there is no significant change.>>
...
>
> Very strong, strong, weak, very week, do not know
- <Very Weak, axis is upside down and looks like the opposite actually occured (gun deaths seemed to increase)>>
...
Y axis on both sides differ(Autism vs MMR coverage), correlation does not equal causation
### Case Study 2: A case for pie charts
Mentioned that pie charts are not a good idea.
